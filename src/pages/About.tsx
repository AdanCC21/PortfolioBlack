            ...
            <div className="relative z-10 flex flex-col gap-8 md:flex-row md:justify-between lg:h-[60vh]">
                ...
                <section className="flex flex-col gap-4 size-full order-2 md:order-1 md:w-3/4">
                    ...
                    <ul className="flex gap-2 flex-wrap">
                        <Tag labelSize="text-sm" label="React" icon={{ src: Icons.react, alt: 'React', className: "size-3" }} />
                        <Tag labelSize="text-sm" label="React Native" icon={{ src: Icons.react, alt: 'React Native', className: 'size-3' }} />
                        <Tag labelSize="text-sm" label="Tailwindcss" icon={{ src: Icons.tailwindcss, alt: 'Tailwindcss', className: 'size-3' }} />
                        <Tag labelSize="text-sm" label="Angular" icon={{ src: Icons.angular, alt: 'Angular', className: 'size-3' }} />
                        <Tag labelSize="text-sm" label="Vue" icon={{ src: Icons.vue, alt: 'Vue', className: 'size-3' }} />
                        <Tag labelSize="text-sm" label="NestJs" icon={{ src: Icons.nestJs, alt: 'NestJs', className: 'size-3' }} />
                        ...
                        <Tag labelSize="text-sm" label=".Net" icon={{ src: Icons.net, alt: '.NET', className: 'size-3' }} />
                        ...
                        <Tag labelSize="text-sm" label="C#" icon={{ src: Icons.cSharp, alt: 'C#', className: 'size-3' }} />
